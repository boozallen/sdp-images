...
// master executors
def masterExecutors = System.getenv("MASTER_EXECUTORS") ?: 0
log "Setting master executors to ${masterExecutors}"
jenkins.setNumExecutors(masterExecutors)
jenkins.save()

// slave agent port
def jnlpPort = System.getenv("JNLP_PORT") ?: 50000
log "Setting agent port to ${jnlpPort}"
