...
rm -rf \
  /root/prebuild/dependencies/app/jenkins/WEB-INF/lib/{commons-beanutils-1.9.3.jar,commons-fileupload-1.3.1-jenkins-2.jar,handlebars-1.1.1-core-assets.jar,commons-jelly-tags-fmt-1.0.jar,xstream-1.4.15.jar,jna-4.5.2.jar} \
...
cp /root/prebuild/dependencies/app/repo/com/thoughtworks/xstream/xstream/1.4.17/xstream-1.4.17.jar /root/prebuild/dependencies/app/jenkins/WEB-INF/lib/
